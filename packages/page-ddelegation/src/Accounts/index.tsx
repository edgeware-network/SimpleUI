...
function Overview ({ className = '', delegation }: Props): React.ReactElement<Props> {
  ...
  const [sortedAccountsWithDelegation, setSortedAccountsWithDelegation] = useState();
  ...
  // ===================== empty display message issue here ==============================
  useEffect((): void => {
  ...
  return (
    <div className={className}>
      ...
      <Table
        ...
        emptySpinner={t<string>("You don't have any accounts. Some features are currently hidden and will only become available once you have accounts.")}
        isEmpty={t<string>("You don't have any accounts. Some features are currently hidden and will only become available once you have accounts.")}
